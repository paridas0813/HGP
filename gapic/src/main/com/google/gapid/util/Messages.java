...
public interface Messages {
  public static final String WINDOW_TITLE = "HyperOS GPU Profiler";
  ...
  public static final String WELCOME_TEXT = "HGP allows you to inspect, tweak, and replay calls" +
  ...
  public static final String UPDATE_CHECK_OPTION = "Automatically check for HyperOS GPU Profiler updates";
  ...
  public static final String UPDATE_CHECK_NO_UPDATE =
      "No new version of H was found. You are up-to-date!";
  public static final String UPDATE_CHECK_UPDATE = "A new version of Hyper is available.";
  ...
  public static final String SERVER_ERROR_MESSAGE =
      ...
      "Most functions in H are unavailable without a server. \n" +
      "You can restart the server, exit HGP, or close the dialog to continue without a server.";
  public static final String BUG_BODY =
      "HGP Version: " + GAPID_VERSION.toString() + "\n" +
      "OS: " + OS.name + " " + OS.arch + "\n\n" +
  ...
  public static final String QUERY_VIEW_WINDOW_TITLE = "HGP - Query Shell";

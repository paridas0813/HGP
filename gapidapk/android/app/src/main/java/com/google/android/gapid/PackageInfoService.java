...
public class PackageInfoService extends GapidService {
    ...
    private String getPackageInfo(
        ...
        try (Counter.Scope t = Counter.time("getInstalledPackages")) {
            ...
            //packages = caches.packageManager.getInstalledPackages(0);
            Log.w(TAG,"current package count is  "+  packages.size());
        }
        ...
        for (PackageInfo packageInfo : packages) {
         ...
         Log.w(TAG,"current package name is " + packageInfo.packageName);
      ...
      //  Log.w(TAG, "getPackageInfo :" + root.toString());
